  ...
  render() {
    ...
    return (
      <>
        ...
        <div className='bar'>
          <div className="pages">Total items: {this.state.todoList.length}</div>
          <div className="pages">Current page is {this.state.currentPage + 1}</div>
          <div className="pages">
            Total pages:{' '}
            ...
            <Modal title="To Do Item" close={this.toggleDetails} >
              <div className="modal">
                ...
                <header>
                  ...
                  <span >Difficulty: {this.state.details.difficulty} {console.log('pppppp', this.state.details)
                  }</span>
                </header>
              </div>
            </Modal>
